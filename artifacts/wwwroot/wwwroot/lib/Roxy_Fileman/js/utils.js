...
RoxyUtils.LoadConfig = function(){
  $.ajax({
      ...
      success: function(data){
        ...
        //cannot use window.parent.postMessage cause it wont call directly
        window.parent.document.dispatchEvent(new CustomEvent("RoxyFilemanConfigLoaded", { detail: RoxyFilemanConf }))
      },
      error: function(data){
